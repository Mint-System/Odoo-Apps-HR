...
class HolidaysType(models.Model):
    ...
    def get_employees_days(self, employee_ids, date=None):
        ...
        # result = super(HolidaysType, self).get_employees_days(employee_ids, date=None)
        ...
        for request in requests:
            ...
            status_dict["virtual_remaining_leaves"] -= (
                request.number_of_hours_display if request.leave_type_request_unit == "hour" else request.number_of_days
            )
