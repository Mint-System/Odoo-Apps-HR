...
def get_attendances(self, employees, start_date, end_date):
    ...
    for employee in employees:
        ...
        _logger.warning(
            f"#### glz_up_to_this_month: {glz_up_to_this_month}, total_overtime_up_to_this_month: {total_overtime_up_to_this_month}, overtime_and_glz_up_to_this_month: {overtime_and_glz_up_to_this_month} "
        )
...
def _get_report_values(self, docids, data=None, report_name=None):
    ...
    return {
        ...
        "show_odoo_overtimes": data.get("show_odoo_overtimes", True),
