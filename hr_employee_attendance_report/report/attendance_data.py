...
def get_attendances(self, employees, start_date, end_date):
    ...
    for employee in employees:
        ...
        leave_hours = sum(leave_ids.holiday_id.mapped("number_of_hours"))
        ...
        planned_hours = 0
        overtime = 0
        for check_date in _daterange(start_date, end_date):
            # Get work hours
            ...
            if active_leaves.holiday_id:
                number_of_hours = active_leaves.holiday_id.number_of_hours
